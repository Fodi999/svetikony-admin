...
export const UPSTREAM_ENDPOINTS = {
  ...
  visualizerEvents: "/api/admin/church-content/visualizer-events", // ✅ verified, full CRUD
  visualizerModels: "/api/admin/church-content/visualizer-models", // ✅ verified, full CRUD + [id]/set-base-earth
  media: {
...
export const BFF_ENDPOINTS = {
  ...
  visualizerEvents: "/api/bff/visualizer-events", // ✅ implemented, full CRUD
  visualizerModels: "/api/bff/visualizer-models", // ✅ implemented, full CRUD; `${visualizerModels}/:id/set-base-earth` built at call sites
